...
export const ribbittingFrogExists = (frogs: Frog[]): boolean =>
...
export const negativeExists = (numbers: number[]): boolean =>
  Arr.exists(numbers, num => num <= 0)
